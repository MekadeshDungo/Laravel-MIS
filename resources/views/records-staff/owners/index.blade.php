...
<div class="p-4 md:p-6">
    ...
    <div class="bg-white rounded-xl shadow-sm mb-6">
        <div class="p-6">
            <form method="GET" action="{{ route('records-staff.owners.index') }}" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="flex items-end gap-2">
                    ...
                    <a href="{{ route('records-staff.owners.index') }}" class="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition">Clear</a>
                </div>
            </form>
        </div>
    </div>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        @foreach($owners as $owner)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <a href="{{ route('records-staff.owners.show', $owner) }}" class="p-2 text-info hover:bg-info hover:bg-opacity-10 rounded-lg transition" title="View">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                </td>
                            </tr>
