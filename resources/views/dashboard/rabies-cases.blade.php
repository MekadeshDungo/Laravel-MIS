...
<div class="max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        <a href="{{ route($rolePrefix . '.rabies-cases.index') }}"
        ...
        <a href="{{ route($rolePrefix . '.rabies-cases.index') }}?status=open"
        ...
        <a href="{{ route($rolePrefix . '.rabies-cases.index') }}?status=under_investigation"
        ...
        <a href="{{ route($rolePrefix . '.rabies-cases.index') }}?status=closed"
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 md:p-6 mb-6">
        <form method="GET" action="{{ route($rolePrefix . '.rabies-cases.index') }}" class="space-y-4">
                ...
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4">
                                <a href="{{ route($rolePrefix . '.rabies-cases.show', $case->id) }}"
