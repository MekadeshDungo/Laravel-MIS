            ...
            <div class="flex justify-between items-center py-4">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Dasmariñas City Veterinary Services</p>
                    </div>
                </div>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden card-hover">
                    ...
                    <div class="p-6">
                        ...
                        <a href="{{ url('/missing-pets') }}" class="w-full bg-amber-500 text-white py-3 rounded-xl font-semibold hover:bg-amber-600 transition-colors">
                            Report Now
                        </a>
                    </div>
                </div>
            ...
            <div class="grid md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="#" class="text-gray-600 hover:text-primary transition-colors">FAQs</a></li>
                    </ul>
                </div>
